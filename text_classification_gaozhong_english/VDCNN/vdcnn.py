...
class VDCNN():
    def __init__(self, num_classes, sequence_max_length=1024, num_quantized_chars=491, embedding_size=16, 
        ...
        with tf.name_scope("loss"):
            losses = tf.nn.sigmoid_cross_entropy_with_logits(logits=self.fc3, labels=self.input_y)
