...
def abcnn(attention=1, dimx=250, dimy=250, nb_filter = 72,
...
#     mul = MatchScore(x,y) 
# =============================================================================
    x = Input(shape=(?,dimx),dtype='float32',name='x')   
    y = Input(shape=(?,dimy),dtype='float32',name='y')    
    mul = MatchScore(x,y) 
    ...
    score = Dense(72,activation='sigmoid',name='score')(h)
    model = Model([x, y],[score])
