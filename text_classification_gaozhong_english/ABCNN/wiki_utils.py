...
def load_wiki(model_name, glove_fname):
    data_train = open('_deeplearn_utils/data/wiki/WikiQA-train.txt','r', encoding='UTF-8').readlines()
    data_test= open('_deeplearn_utils/data/wiki/WikiQA-test.txt','r', encoding='UTF-8').readlines()
    data_dev = open('_deeplearn_utils/data/wiki/WikiQA-dev.txt','r', encoding='UTF-8').readlines()
    res_fname = 'new_ref'
